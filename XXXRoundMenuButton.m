...
- (void)setMainColor:(UIColor *)mainColor
{
    ...
    self.centerButton.selectedColor = [UIColor colorWithRed:0.04 green:0.57 blue:0.94 alpha:1.0];
...
- (void)centerButtonClicked:(UIButton*)sender
{
    ...
    if (sender.selected) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"UnClicked" object:nil];
    }
}
