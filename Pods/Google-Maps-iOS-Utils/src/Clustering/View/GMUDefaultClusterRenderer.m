...
- (void) view {
    ...
    iconview.layer.borderColor = [UIColor clearColor].CGColor;
    iconview.clipsToBounds = YES;
}

- (void) view_0 {
    
    placeview = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 30, 35)];
}
...
- (GMSMarker *)markerWithPosition:(CLLocationCoordinate2D)position
  ...
  if (clusterIcon != nil) {
    ...
    marker.groundAnchor = CGPointMake(0.5, 0.5);
      ...
      if ([[[marker valueForKey:@"_userData"] valueForKey:@"_type"] isEqualToString:@"place"]) {
          placeview.image = [UIImage imageNamed:[[marker valueForKey:@"_userData"] valueForKey:@"_icons"]];
          marker.iconView = placeview;
      } else if ([[[marker valueForKey:@"_userData"] valueForKey:@"_type"] isEqualToString:@"event"]) {
          placeview.image = [UIImage imageNamed:@"map_icon_event.pdf"];
          marker.iconView = placeview;
      } else if ([[[marker valueForKey:@"_userData"] valueForKey:@"_type"] isEqualToString:@"user"]) {
          if ([[marker valueForKey:@"_userData"] valueForKey:@"_icon_user"] == [NSNull null]) {
              //marker.icon = [UIImage imageNamed:@"yes.png"];
          } else {
              [iconview setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://motomoto.2-wm.ru%@", [[marker valueForKey:@"_userData"] valueForKey:@"_icon_user"]]]];
