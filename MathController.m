...
+ (NSArray *)colorSegmentsForLocations:(NSArray *)locations
{
    ...
    for (int i = 1; i < locations.count; i++)
    {
        ...
        CLLocation *firstLocCL = [[CLLocation alloc] initWithLatitude:firstLoc.latitude.doubleValue longitude:firstLoc.langitude.doubleValue];
        CLLocation *secondLocCL = [[CLLocation alloc] initWithLatitude:secondLoc.latitude.doubleValue longitude:secondLoc.langitude.doubleValue];
        
        double distance = [secondLocCL distanceFromLocation:firstLocCL];
        double time = [secondLoc.timstamp timeIntervalSinceDate:firstLoc.timstamp];
    ...
    for (int i = 1; i < locations.count; i++) {
        ...
        coords[0].longitude = firstLoc.langitude.doubleValue;
        
        coords[1].latitude = secondLoc.latitude.doubleValue;
        coords[1].longitude = secondLoc.langitude.doubleValue;
